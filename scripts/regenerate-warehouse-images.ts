...
const STYLE = "Clean modern editorial commercial photography. Natural daylight where possible, soft cinematic color grading with subtle warm undertones, shallow depth of field, neutral palette with a hint of forest green to align with brand. Premium, calm, contemporary — the look of a top-tier modern food-distribution facility. No text overlays, no watermarks. Preserve any visible 'L&C' or '陈氏食品公司' green logo branding accurately when it appears in the reference. Real-warehouse signatures to keep visible so it's still recognizably L&C's operation: BLUE steel pallet racking with ORANGE diagonal braces and YELLOW safety bollards at the base (the racking color from the references), and the ORANGE Toyota forklift from the references. Otherwise the building itself should read as a modern, well-lit, professionally finished distribution center — clean industrial high ceiling with exposed steel structure and clean overhead strip lighting, semi-polished concrete floor, tall organized racking, neatly palletized inventory. Do not depict a low dark wood-beam working warehouse, do not depict rough timber posts, do not depict scuffed or rustic surfaces — this is the marketing presentation of the operation, not a documentary photo of the older space.";
...
const JOBS: Job[] = [
  {
    ...
    prompt:
      "Wide interior of the L&C food distribution warehouse, hero shot for a website: TALL BLUE steel pallet racking with ORANGE diagonal braces stacked with neatly palletized cardboard cases lining both sides of a long center aisle, polished concrete floor with subtle sheen, an ORANGE Toyota forklift in soft focus mid-aisle (the iconic orange Toyota body and lift mast clearly visible as in the reference photos), a few YELLOW safety bollards at the base of the racking uprights. Clean modern high industrial ceiling with exposed steel structure and rows of clean overhead fluorescent strip lighting providing bright even ambient light. The far end of the aisle is fully and completely OPEN to the outside — the building simply ends and opens directly onto bright daylight and the loading yard beyond. There is NO door of any kind at the far end: do not depict a roll-up door, a glass loading-bay door, a dock-leveler door, an entrance door, a sliding door, or any door frame or hardware whatsoever. The opening is an unobstructed rectangular aperture flooded with warm natural daylight pouring straight into the warehouse. Composition reads as a confident hero image — tidy, well-stocked, well-lit, active without being chaotic, the marketing-quality presentation of a top-tier modern distribution operation. Keep ONLY these signatures from the real warehouse references: the BLUE racking with ORANGE braces, the YELLOW base bollards, and the ORANGE Toyota forklift. Do not depict a low wood-beam ceiling, do not depict dark stained timber posts, do not depict a rustic or worn-down working warehouse, do not depict scuffed concrete — the rest of the space should look like a modern, professionally finished, well-maintained distribution center.",
  },
  {
    file: "about-hero",
    aspectRatio: "16:9",
