  ...
  zh: {
    ...
    home: {
      ...
      about: {
        title: "关于 L&C 食品分销",
        body1:
          "在 L&C 食品分销，我们不仅交付产品，我们更交付安心。作为您的业务合作伙伴，我们的使命是让您的采购更简单、稳定、且具成本效益。",
        body2:
          "准备好体验不同了吗？自1995年以来，我们以始终如一的品质和可靠的服务，遍布加州的众多餐厅。",
      },
      services: {
        title: "我们的服务",
      ...
      finalCta: {
        title: "准备好与我们合作了吗？",
        body: "加入加州数百家成功餐厅的行列，信赖 L&C 食品分销，满足食材供应需求。",
      },
    },
    footer: {
      tagline: "您值得信赖的亚洲食品分销合作伙伴。全球美食，本地服务。",
      quickLinks: "快速链接",
      contact: "联系方式",
      hours: "周一 至 周五：上午8:00 – 下午5:00",
      legal: "法律",
      privacy: "隐私政策",
      terms: "服务条款",
      accessibility: "无障碍声明",
    ...
    products: {
      hero: {
        badge: "产品目录",
        title: "您厨房运转所需的一切。",
        subtitle: "只要您厨房用得上，我们都能采购到。每辆货车背后都是一个由 180+ 供应商组成的网络，自1995年起服务全加州。",
      },
      stats: {
        eyebrow: "数据一览",
      ...
      process: {
        ...
        step2: { title: "我们品控与备货", body: "从收货到备货全程冷链监控。每个订单都经过严格检查与登记；确保产品合格才能发货。" },
        step3: { title: "我们配送", body: "加州四个配送中心，一周六天为您服务。一个负责到底的团队，如有疑问，您只需拨打一个号码，随时为您解答。" },
      },
      finalCta: {
        title: "准备好开启您的专属食材库了吗？",
    ...
    about: {
      ...
      story: {
        title: "我们的故事",
        body1: "1995年，L&C 食品分销在圣地亚哥萌生。当时我们的初心很简单：如何才能更好地服务亚洲餐厅、优化他们的供应链？正是这个初心，驱使着我们一路不断地追求卓越，不负每一份信赖。",
        body2: "我们的征程始于一个纯粹的使命：在优质亚洲食材与扎根社区的餐饮业之间，搭建一座无缝桥梁。我们深知，承载味道的不仅是食材，更是供应链努力的结果。客户的成功就是我们的成功。正是这份精益求精、迎难而上的坚持，让我们荣幸至今，始终陪伴在您身边。",
        body3: "时至今日，我们已在加州战略布局四大配送中心。我们依然坚守最初的承诺，传承家族企业的核心价值，服务着数百家餐厅伙伴。我们的每一步成长，都离不开您每天给予的信任。",
        yearsBadgeLabel: "年卓越服务",
      },
      ingredients: {
        title: "我们成功的要素",
        subtitle: "指引我们一切行动的核心原则",
        integrity: { title: "诚信与透明", description: "诚实定价、清晰沟通、可追溯的决策。每一笔订单都是我们用心兑现的承诺。" },
        hunger: { title: "持续改进", description: "我们持续打磨服务：更精准的采购、更高效的物流，让您得到全方面的满意。" },
        buyingPower: { title: "采购优势", description: "通过合作伙伴网络汇集的采购量解锁更优的价格来提升您的品牌成长。" },
        partnership: { title: "真正的伙伴关系", description: "我们交付的不仅是订单，更是与您并肩同行、共享成功的决心。" },
      },
      builtForScale: {
        title: "赋能连锁，无忧扩张",
        body1: "我们深耕加州，与各大餐饮连锁品牌深度合作。我们承诺为您的每一家门店提供品质如一、稳定可靠的货源，确保您的品牌在任何市场都能保持高标准的顾客体验",
        body2: "需要特殊食材或独家定制配方？我们提供按需规格化采购，为您量身定制专属商品。让您专注打造招牌菜单、无需分心跨国寻源，一切繁琐供应，皆融入我们高效简化的一体化产品线中。",
      },
      locations: {
        title: "我们的网点",
